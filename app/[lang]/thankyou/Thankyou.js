  ...
  return (
    <div className="relative  overflow-hidden w-screen max-w-[1080pxpx] min-h-[1920px] space-y-8 px-8 py-8">
      ...
      <div className="flex flex-col justify-center items-center space-y-4 py-6">
        ...
        <div className="flex flex-col justify-center items-center text-[10rem] font-extrabold text-carpetMoss">
          ...
          <h1 className="stroke flex justify-center items-center drop-shadow-[0_1px_2px_rgb(0,0,0,0.5)] ">
            ...
            <div className="relative m-1">
              ...
              <div className="w-40 h-40 overflow-hidden rounded-full border-2 border-white">
                <Image
                  src={"/images/logo.png"}
                  width={100}
                  height={100}
          ...
          {/* Thank You Message */}
          <p className="text-3xl text-center text-gray-500 font-normal">
            {thankyoumsg}
          </p>
        </div>
        ...
        <div className="flex flex-col justify-center items-center py-8 ">
          <Link
            href={"/"}
            className="relative px-8 py-2 line-clamp-3 border-solid border-2 border-carpetMoss rounded-full text-carpetMoss text-center h-18 font-semibold text-3xl"
          >
            {gohome}
          </Link>
        </div>
        <div className="flex flex-col justify-end items-center pt-20 space-y-2">
          <IoReceiptOutline className="text-carpetMoss text-9xl" />

          <p className="text-3xl text-gray-500 font-normal mt-4">
            {collectyourreceipt}
          </p>
        </div>
      </div>
